...
#define STICK20_CMD_PRODUCTION_TEST_WITH_WRITE_TEST     (STICK20_CMD_START_VALUE + 27)

#define STICK20_CMD_ENABLE_ADMIN_READONLY_UNCRYPTED_LUN       (STICK20_CMD_START_VALUE + 28)
#define STICK20_CMD_ENABLE_ADMIN_READWRITE_UNCRYPTED_LUN      (STICK20_CMD_START_VALUE + 29)

#define STICK20_CMD_ENABLE_ADMIN_READONLY_ENCRYPTED_LUN       (STICK20_CMD_START_VALUE + 30)
#define STICK20_CMD_ENABLE_ADMIN_READWRITE_ENCRYPTED_LUN      (STICK20_CMD_START_VALUE + 31)

#define STICK20_CMD_CHECK_SMARTCARD_USAGE               (STICK20_CMD_START_VALUE + 32)
#define STICK20_CMD_WINK                                (STICK20_CMD_START_VALUE + 33)


/*
   #define STICK20_CMD_SEND_PASSWORD_RETRY_COUNT (STICK20_CMD_START_VALUE + 22)

   #define STICK20_CMD_INIT_HIDDEN_VOLUME_SLOT (STICK20_CMD_START_VALUE + 23) #define STICK20_CMD_SAVE_HIDDEN_VOLUME_SLOT (STICK20_CMD_START_VALUE +
   24) #define STICK20_CMD_READ_HIDDEN_VOLUME_SLOT (STICK20_CMD_START_VALUE + 25) */
...
/*
   #define OUTPUT_LAST_CMD_TYPE_OFFSET 0 #define OUTPUT_CMD_CRC_OFFSET 1 #define OUTPUT_CMD_STATUS_OFFSET 5 #define OUTPUT_CMD_RESULT_OFFSET 6 */
