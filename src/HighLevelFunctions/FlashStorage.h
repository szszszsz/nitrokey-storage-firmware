...
typedef struct
{
    u16 MagicNumber_StickConfig_u16;    // Shows that the structure is valid 2 byte // 2
    u8 ReadWriteFlagUncryptedVolume_u8; // Flag stores the read/write flag in the CPU flash 1 byte // 3
